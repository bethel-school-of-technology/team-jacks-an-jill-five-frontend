    ...
    <>
      ...
      <div className="row">
        ...
        <div class="container">
          <div className="row">
            <div className="col-md-3 col-lg-4">
              ...
              <label className="card-container" for="profileCard">
                  ...
                  <div className="card front">
                    <div className="card-block">
                      ...
                      <img
                        ...
                        src={HowardHenson}
                      />
                      <h4 id="profile_h4" className="card-title">Howard Henson</h4>
        ...
        <!-- Card Back - Profile 1  --> */}
          ...
          <label className="col-md-4 card-container" for="profileCard2">
            <div className="card-flip">
              ...
              <div class="card front">
                <div class="card-block">
                  ...
                  <img
                    ...
                    src={CFoster}
                  />
                  <h4 id="profile_h4" class="card-title">Christina Foster</h4>
                  <h6 id="profile_h6" class="card-subtitle text-muted">Co-Founder</h6>
                  <div className="card-body">
                    <h3>Hi 👋</h3>
                    <p>
              ...
              <div className="card back text-center">
                <div className="card-block">
                  ...
                  <div className="card-img-overlay">
                    ...
                    <p className="fav-food">The Scrambler</p>
                    <br />
                    ...
                    <p id="profile_p" className="fair-advice">"Fairs are fun with friends...not blind dates!"</p>
                  </div>
                </div>
              </div>
        ...
        <label className="card-container" for="profileCard3">
          <div className="card-flip">
            ...
            <div class="card front">
              <div class="card-block">
                ...
                <img
                  ...
                  src=""
                />
                <h4 id="profile_h4" class="card-title">Joshua Betrand</h4>
                <h6 id="profile_h6" class="card-subtitle text-muted">Co-Founder</h6>
                <div className="card-body">
                  <h3>Hi 👋</h3>
                  <p>
            ...
            <div className="card back text-center">
              <div className="card-block">
                ...
                <div className="card-img-overlay">
                  ...
                  <br />
                  <h3 id="profile_h3" className="fav-text"> Fair Advice: </h3><span />
                  <p id="profile_p" className="fair-advice">"I love all rides at fairs. I try my best
        ...
        <label className="card-container" for="profileCard4">
          <div className="card-flip">
            ...
            <div class="card front">
              <div class="card-block">
                ...
                <img
                  ...
                  src={Samuel}
                />
                <h4 id="profile_h4" class="card-title">Samuel Akins</h4>
                <h6 id="profile_h6" class="card-subtitle text-muted">Co-Founder</h6>
                <div className="card-body">
                  <h3>Hi 👋</h3>
                  <p>
            ...
            <div className="card back text-center">
              <div className="card-block">
                ...
                <div className="card-img-overlay">
                  ...
                  <p id="profile_p" className="fav-food"></p>
                  <br />
                  <h3 id="profile_h3" className="fav-text"> </h3><span />
          ...
          <div className="card-flip">
            ...
            <div class="card front">
              <div class="card-block">
                ...
                />
                <h4 id="profile_h4" class="card-title">Kyle Hammersmith</h4>
                <h6 id="profile_h6" class="card-subtitle text-muted">Co-Founder</h6>
                <div className="card-body">
                  <h3>Hi 👋</h3>
                  <p>
            ...
            <div className="card back text-center">
              <div className="card-block">
                ...
                <div className="card-img-overlay">
                  ...
                  <h1 id="profile_h1" className="Favorite">Fair Favorites:</h1>
                  <hr />
                  <h3 id="profile_h3" className="fav-text"> Fav Food: </h3><br />
                  <p id="profile_p" className="fav-food">Corn dogs, cotton candy, and strawberry shortcake</p>
                  <br />
                  <h3 id="profile_h3" className="fav-text">Fair advice:</h3><br />
